...
def results_to_log(
    ...
    for result in results:
        ...
        plate_run_name = result.args[6].name
...
def run_cellprofiler_parallel(
    ...
    # make logs directory
    log_dir = pathlib.Path("/home/maggiekeating/Illumination-correction-benchmarking/multiple_pipelines_example/outputs/IC_logs")
    ...
    futures: List[Future] = [
        ...
        #/home/maggiekeating/Documents/Illumination-correction-benchmarking/.gitignore
    ...
    for result in results:
        ...
        if result.returncode == 1:
            print(
                f"A return code of {result.returncode} was returned for {plate_run_name}, which means there was an error in the CellProfiler run."
            )
